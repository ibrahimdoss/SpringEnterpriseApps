...
public class ClassPathXmlApplicationContextExample {
	...
	public static void loadBeans1() {
		...
		context.setConfigLocation("beanFactoryExample/resources/beans.xml");
		context.refresh();
	...
	public static void loadBeans2() {
		ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("beanFactoryExample/resources/beans.xml");
		BeanB beanB = context.getBean(BeanB.class);
		System.out.println(beanB);
	}

	public static void loadBeans3() {
		ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("beanFactoryExample/resources/beans.xml", "beanFactoryExample/resources/anotherBeans.xml");		
		BeanD beanD = context.getBean(BeanD.class);
		System.out.println(beanD);
	}
	
	public static void loadBeans4() {
		ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("beanFactoryExample/beans.xml", "beanFactoryExample/resources/anotherBeans.xml");		
...
//		System.out.println(beanc);
	...
	public static void loadBeans6() {
		ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("beanFactoryExample/resources/beans.xml", "beanFactoryExample/resources/anotherBeans.xml", "beanFactoryExample/resources/yetAnotherBeans.xml");		
